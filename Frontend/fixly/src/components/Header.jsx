      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/providers" className="text-gray-700 hover:text-primary-600 transition-colors">
              Providers
            </Link>
            ...
            {user ? (
              <div className="flex items-center space-x-4">
                ...
                {user.role === "provider" && (
                  <Link to="/provider-dashboard" className="text-gray-700 hover:text-primary-600 transition-colors">
                    Provider
                  </Link>
                )}
